        ...
        <div className="bg-black text-white min-h-screen px-6 py-12 font-sans leading-relaxed">
          <div className="max-w-4xl mx-auto">
            ...
            <section className="space-y-6 text-gray-300">
              <p>
               For the purpose of these Terms and Conditions, The term "we", "us", "our" used anywhere on this page shall mean Srinithy properties, whose registered/operational office is 14c Vpv avanue 1st street Poonamallee Chennai 56 Chennai TAMIL NADU 600056 . "you", “your”, "user", “visitor” shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us. 
              </p>
              <h2 className="text-xl font-bold text-white">Your use of the website and/or purchase from us are governed by following Terms and Conditions:</h2>
               <ul className="list-disc list-inside space-y-1">
                ...
                <li>
                    You may not create a link to our website from another website or document without Srinithy properties’s prior written consent. 
                </li>
                <li>
