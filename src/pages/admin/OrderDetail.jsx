...
const OrderDetail = () => {
  ...
  const markAsShipped = async (order) => {
    const { id, email, firstName, lastName, order_id, cartItems, totalPaid, address, city, state, pin, phone, apartment, ImageUrl1  } =
      order;
    ...
    <div style="max-width:600px;margin:auto;background-color:#1a1a1a;padding:30px;border-radius:8px;border:1px solid #333;">
      ...
      ${cartItems
        ...
        <div style="display:flex;align-items:center;margin-bottom:15px;border-bottom:1px solid #333;padding-bottom:10px;">
          <img src="${item.ImageUrl1}" alt="${item.name}" width="60" height="60" style="border-radius:4px;margin-right:15px;">
          <div style="flex:1;">
