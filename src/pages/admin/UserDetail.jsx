        ...
        <div>
            <div>
                <div className="py-5 flex justify-between items-center">
                    {/* text  */}
                    <h1 className=" text-xl text-white font-bold">All User</h1>
                </div>
                                ...
                                getAllUser.map((value, index) => {
                                    return (
                                        <tr key={index} className="text-white">
                                            <td
                                                className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-white stroke-slate-500 text-slate-500 ">
                                                {index + 1}
                                            </td>

                                            <td
                                                className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-white stroke-slate-500 text-slate-500 first-letter:uppercase ">
                                                {value.name}
                                            </td>
